    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        if (password == "8367")
        {
            ...
            while (true)
            {
                ...
                if (adminOption == 1) addCar();
                else if (adminOption == 2) viewAllCars();
                else if (adminOption == 3) updatePrice();
                else if (adminOption == 4) updateStock();
                else if (adminOption == 5) deleteCar();
                else if (adminOption == 6) lowStockAlert();
                else if (adminOption == 7) salesReport();
                else if (adminOption == 8) viewTestDrives();
                else if (adminOption == 9) profitCalculator();
                else if (adminOption == 10) viewFeedback();
                else if (adminOption == 11) break;
...
void customerMenu()
{
    ...
    while (true)
    {
        ...
        if (userOption == 1) viewAllCars();
        else if (userOption == 2) budgetSearch();
        else if (userOption == 3) nameSearch();
        else if (userOption == 4) bookCar();
        else if (userOption == 5) compareCars();
        else if (userOption == 6) priceAnalysis();
        else if (userOption == 7) bookTestDrive();
        else if (userOption == 8) giveFeedback();
        else if (userOption == 9) break;
        else cout << "Wrong Option Entered" << endl;
...
void viewFeedback()
{
    ...
    if (averageRating >= 4.5) cout << "EXCELLENT! Customers love BMW!" << endl;
    else if (averageRating >= 3.5) cout << "GOOD! Customers are satisfied!" << endl;
    else if (averageRating >= 2.5) cout << "AVERAGE! Need some improvements." << endl;
    else cout << "POOR! Immediate action needed!" << endl;
}
...
void budgetSearch()
{
    ...
    if (found == 0) cout << "SORRY! No car under this budget!" << endl;
}
...
void priceAnalysis()
{
    ...
    if (sortType == 1 || sortType == 2)
    {
        ...
        for (int i = 0; i < carCount - 1; i++)
        {
            ...
            {
                bool needSwap = false;
                if (sortType == 1 && tempPrices[j] > tempPrices[j + 1]) needSwap = true;
                if (sortType == 2 && tempPrices[j] < tempPrices[j + 1]) needSwap = true;
